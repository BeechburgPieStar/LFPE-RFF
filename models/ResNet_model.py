...
class ResNet(nn.Module):
    ...
    # 修改：增加了 in_channels 参数
    def __init__(self, block, num_block, num_classes=100, in_channels=2):
        super().__init__()
...
def resnet18(num_class, in_channels=2):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_class, in_channels)